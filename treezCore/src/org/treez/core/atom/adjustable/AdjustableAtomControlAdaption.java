...
public class AdjustableAtomControlAdaption extends AbstractControlAdaption {
	...
	private static Logger sysLog = Logger.getLogger(AdjustableAtomControlAdaption.class);
	 ...
	 */
	public AdjustableAtomControlAdaption(
			Composite parent,
	 ...
	 * @param model
	 */
	private static void createPropertyControlFromModel(
			Composite parent,
			AbstractAtom model,
			Refreshable treeViewerRefreshable) {
		...
		Color colorBackgroundInactive = display.getSystemColor(SWT.COLOR_TITLE_INACTIVE_BACKGROUND_GRADIENT);
		Color colorBackgroundActive = display.getSystemColor(SWT.COLOR_TITLE_BACKGROUND);

		//create tab folder
		CTabFolder tabFolder = createTabbedFolder(parent, colorBackgroundInactive, colorBackgroundActive);
	 ...
	 * @return
	 */
	private static CTabFolder createTabbedFolder(
			Composite parent,
			Color colorBackgroundInactive,
			Color colorBackgroundActive) {

		CTabFolder tabFolder = new CTabFolder(parent, SWT.TOP);
		tabFolder.setSimple(false);

		Color[] backgroundColors = new Color[] { colorBackgroundInactive, colorBackgroundActive };
	 ...
	 * @param tabFolder
	 */
	private static void createTabbedPages(AbstractAtom model, CTabFolder tabFolder, Refreshable treeViewerRefreshable) {
