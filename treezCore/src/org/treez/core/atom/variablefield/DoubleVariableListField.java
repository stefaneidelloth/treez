 ...
 */
public class DoubleVariableListField extends AbstractAttributeAtom<List<Double>> {

	/**
	 * Logger for this class
	 */
	@SuppressWarnings("unused")
	private static Logger sysLog = Logger.getLogger(DoubleVariableListField.class);
	...
	public AbstractAttributeAtom<List<Double>> createAttributeAtomControl(Composite parent, Refreshable treeViewerRefreshable) {
	...
	public List<Double> get() {
		List<Double> quantities = createDoubleList(getValueString());
		return quantities;
	}
