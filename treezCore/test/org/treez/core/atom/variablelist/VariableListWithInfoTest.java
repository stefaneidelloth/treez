 ...
 */
public class VariableListWithInfoTest extends AbstractAttributeAtomConstructionTest<List<VariableField<?, ?>>> {

	/**
	 * Logger for this class
	 */
	@SuppressWarnings("unused")
	private static final Logger LOG = LogManager.getLogger(VariableListWithInfoTest.class);
	...
	public void createTestAtom() {
		...
		//create test atom
		VariableListWithInfo variableList = new VariableListWithInfo(atomName);
		variableList.setLabel("Variables");
		variableList.setAvailableVariables(variables);

		variableList.setVariableInfo(firstField.getName(), "myFlag info");
		variableList.setVariableInfo(secondField.getName(), "myString info");
