...
public class PlotlyPieDemo extends Application {
	...
	private void createPlotlyExample() {
		...
		String[] labels = { "4.0", "8.0", "15.0", "16.0", "23.0", "42.0" };	

		SingleData singleData = plotly.createSingleData();
		singleData.setValues(values);
		singleData.setLabels(labels);
		singleData.setType(PlotlyType.PIE);
		...
		//Selection svgSelection = plotly.getSvg();
		//Element svgElement = svgSelection.node();		
