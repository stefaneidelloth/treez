...
/**
 * Code adaption for VeuszPropertiesPage
 */
public class VeuszPropertiesPageCodeAdaption extends AdjustableAtomCodeAdaption {
	 ...
	 * @param atom
	 */
	public VeuszPropertiesPageCodeAdaption(VeuszPropertiesPage atom) {
		super(atom);
	}
