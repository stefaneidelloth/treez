...
public class Fill implements GraphicsPropertiesPageFactory {
	...
	private void rePlotRects(D3 d3, GraphicsAtom parent) {
		removeOldRects();
		plotNewRects(d3, parent);
	...
	private void plotNewRects(D3 d3, GraphicsAtom parent) {
	...
	private static double determineBarHeight(
		...
		if (positionSize > 1) {
			...
			defaultBarHeight = graphHeight / 3;
		}
