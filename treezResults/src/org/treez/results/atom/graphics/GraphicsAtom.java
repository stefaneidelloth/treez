package org.treez.results.atom.graphics;
 ...
 *
 */
public class GraphicsAtom extends AdjustableAtom {
	 ...
	 */
	public void bindStringAttribute(
			Selection selection,
		...
		addModificationConsumer(wrappingAttribute,
				(newValue) -> selection.attr(selectionAttributeName, trim(newValue)));
	}
	 ...
	 * @param selection
	 */
	public void bindDisplayToBooleanAttribute(Selection selection, Attribute<Boolean> wrappingAttribute) {
	 ...
	 * @param topMargin
	 */
	public void bindTranslationAttribute(
			Selection selection,
